    ...
    <div className="flex h-screen overflow-hidden">
      ...
      <aside
        className={`
          ...
          w-64 bg-[#0F1117] border-r border-white/5
      ...
      {/* MAIN */}
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden bg-[#0A0C0F]">

        {/* HEADER */}
        <header className="h-14 bg-[#0F1117] border-b border-white/5 flex items-center px-4 gap-4 flex-shrink-0">
          {/* Botão menu mobile */}
          <button
        ...
        {/* CONTEÚDO */}
        <main className="flex-1 overflow-y-auto p-6 bg-[#0A0C0F]">
          {children}
        </main>
      </div>

      {/* TAB BAR MOBILE */}
      <nav className="md:hidden fixed bottom-0 left-0 right-0 bg-[#0F1117] border-t border-white/5 flex items-center justify-around px-2 py-2 z-10">
